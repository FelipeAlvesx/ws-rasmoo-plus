...
public class SubscriptionTypeController {
    ...
    @PostMapping
    public ResponseEntity<SubscriptionTypeDto> create(@RequestBody @Valid SubscriptionTypeDto subscriptionTypeDto){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SubscriptionType> update(@PathVariable Long id, @RequestBody SubscriptionTypeUpdateDto subscriptionTypeDto){
